		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zuxemployeezuxemployee-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zuxemployeezuxemployee-display": {
								"semanticObject": "zuxemployeezuxemployee",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zuxemployee.zuxemployee",
									"url": sap.ui.require.toUrl("zuxemployee/zuxemployee")
								}
							}
						}
					}
